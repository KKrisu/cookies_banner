...
if(!getCookie('c_accepted')) {
	var wrapper = document.createElement('div');
	wrapper.innerHTML = '<div id="cookie_info" style="color: #444; background: #fff; width: auto; min-width: 750px; max-width: 50%; margin: 0 auto; font: 12px Tahoma sans-serif; padding: 0.5em; border: 2px solid #29f; position: fixed; bottom: 0; left: 0; z-index: 9999;">'
